//Non Static Variable in same Class
package variable;

public class NonnStaticVar {
	...
	public static void main(String[] args) {
		NonnStaticVar ob=new NonnStaticVar();//first call Class name and object name new keyword class name.
